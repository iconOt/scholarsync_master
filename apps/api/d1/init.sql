-- ScholarSync D1 initialization SQL
...
-- seed schools
INSERT OR IGNORE INTO schools(id, school_name, domain, status, onboarding_step, active_students, invoice_due, owner, revenue) VALUES
...
-- seed invoices
INSERT OR IGNORE INTO invoices(id, school_id, term, amount, status, issued_at) VALUES
